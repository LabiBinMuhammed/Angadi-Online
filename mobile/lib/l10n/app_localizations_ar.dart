...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get loyaltyClubTitle => 'نادي المكافآت 5 نجوم';

  @override
  String loyaltyProgressLabel(Object stars) {
    return '$stars / 5 نجوم تم جمعها';
  }

  @override
  String get loyaltyStarEarnedNotice =>
      '🎉 كسبت نجمة +1 على هذا الطلب المُسلّم!';

  @override
  String loyaltyKeepCollectingNotice(Object remaining) {
    return '⭐ إجمع $remaining نجوم إضافية لفتح بطاقة الحظ الكشط التالية!';
  }

  @override
  String get loyaltyScratchCardUnlockedTitle => '🎉 تم فتح بطاقة الحظ الكشط!';

  @override
  String get loyaltyScratchCardUnlockedDesc =>
      'اكشط لتكشف عن مكافأة رصيد أنغادي المضمونة بقيمة ₹2–₹15!';

  @override
  String get loyaltyScratchNowBtn => 'إكشط الآن 🎟️';

  @override
  String get loyaltyScratchDialogTitle => '🎟️ بطاقة الحظ الكشط';

  @override
  String get loyaltyScratchDialogSubtitle =>
      'إحك السطح المعدني لتكشف عن مكافأتك المضمونة!';

  @override
  String get loyaltyClaimRewardBtn => 'مطالبة بالمكافأة 🎁';
  ...
  String loyaltyRewardClaimedSubtitle(Object amount) {
    return 'تمت إضافة رصيد أنغادي بقيمة ₹$amount إلى محفظتك!';
  }
