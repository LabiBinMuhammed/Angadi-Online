    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--text-base)', display: 'flex', alignItems: 'center', gap: '0.6rem', margin: 0 }}>
          <div style={{ background: 'var(--wa-teal)', color: 'white', padding: '0.4rem', borderRadius: '10px', boxShadow: '0 4px 10px rgba(17, 153, 142, 0.2)' }}>
          ...
          <div style={{ gridColumn: '1 / -1', marginTop: '0.5rem', display: 'flex', justifyContent: 'flex-end' }}>
            <button
              ...
              style={{
                ...
                background: loading || !newName.trim() ? 'var(--neutral-300)' : 'linear-gradient(135deg, var(--wa-teal) 0%, #11998e 100%)',
                ...
                {editingId === loc.id ? (
                  ...
                  <>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <div style={{ background: 'linear-gradient(135deg, rgba(17,153,142,0.1) 0%, rgba(56,239,125,0.1) 100%)', padding: '0.75rem', borderRadius: '12px', color: 'var(--wa-teal)' }}>
