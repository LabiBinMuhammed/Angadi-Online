...
import { createShopAction } from '@/app/(vendor)/vendor/shop/actions'
    ...
    <>
      ...
      <div style={{ overflowX: 'auto' }}>
        <table className="data-table">
          <thead><tr><th>Shop</th><th>Owner</th><th>Type</th><th>Location</th><th>Created</th><th>Actions</th></tr></thead>
          <tbody>
            {filtered.map(shop => {
              ...
              return (
                <tr key={shop.id} id={`admin-shop-${shop.id}`}>
                  ...
                  <td>{shop.type ? <span className="badge badge-neutral">{shop.type}</span> : '—'}</td>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: '.5rem' }}>
                      ...
                      <Link href={`/home/shop/${shop.id}`} id={`view-shop-${shop.id}`} className="btn btn-sm btn-outline">
                        View →
                      </Link>
                    </div>
                  </td>
