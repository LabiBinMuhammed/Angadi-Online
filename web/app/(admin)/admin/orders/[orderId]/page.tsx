  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
        <div>
          <h1 className="panel-page-title" style={{ marginBottom: '.15rem' }}>Order #{orderId.slice(0, 8)}</h1>
      ...
      <div className="grid-2" style={{ maxWidth: 640, marginBottom: '1.5rem' }}>
        ...
        <div className="card card-body">
          ...
          <p className="text-sm">{o.payment_type?.toUpperCase()} payment</p>
        </div>
      </div>
      ...
      <div className="wa-list" style={{ marginBottom: '1.5rem' }}>
        {(o.order_items ?? []).map((oi: any) => (
          <div key={oi.id} className="wa-list-item" style={{ cursor: 'default' }}>
            <div className="wa-avatar" style={{ background: 'var(--neutral-100)', fontSize: '1.2rem' }}>
