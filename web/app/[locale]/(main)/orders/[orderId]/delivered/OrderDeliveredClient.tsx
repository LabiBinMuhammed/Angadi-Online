...
import { CheckCircle2, ArrowRight, ShoppingBag, Copy, Check, PackageCheck, Star } from 'lucide-react'
...
export default function OrderDeliveredClient({ orderId, order }: Props) {
  const { t, locale } = useTranslation()
  const [copied, setCopied] = useState(false)

  // Trigger grand celebration confetti on mount
  useEffect(() => {
    // 1. Initial big celebratory burst
    confetti({
      particleCount: 140,
      spread: 100,
      origin: { y: 0.4 },
      colors: ['#22c55e', '#3b82f6', '#f59e0b', '#ec4899', '#8b5cf6', '#00d2d3']
    })

    // 2. Dual side cannons
    const timer1 = setTimeout(() => {
      confetti({ particleCount: 65, angle: 60, spread: 60, origin: { x: 0, y: 0.6 } })
      confetti({ particleCount: 65, angle: 120, spread: 60, origin: { x: 1, y: 0.6 } })
    }, 500)

    // 3. Gold star shower
    const timer2 = setTimeout(() => {
      confetti({ particleCount: 50, spread: 120, origin: { y: 0.5 }, colors: ['#f59e0b', '#fbbf24', '#22c55e'] })
    }, 1500)
  ...
  return (
    <div className="order-delivered-wrap" style={{
      minHeight: '85vh',
      display: 'flex',
      alignItems: 'center',
      ...
      <div className="order-delivered-card fade-up" style={{
        maxWidth: '580px',
        width: '100%',
        ...
        <div style={{
          ...
          width: '260px',
          height: '260px',
          background: 'radial-gradient(circle, rgba(34, 197, 94, 0.2) 0%, rgba(245, 158, 11, 0.05) 50%, rgba(255, 255, 255, 0) 75%)',
          borderRadius: '50%',
          pointerEvents: 'none'
        }} />

        {/* Animated Delivered Checkmark Badge */}
        <div style={{
          width: '96px',
          height: '96px',
          ...
          <PackageCheck size={56} strokeWidth={2.2} color="#ffffff" />
        </div>

        {/* Delivered Title & Subtitle */}
        <h1 style={{
          fontSize: '1.9rem',
          fontWeight: 800,
          color: 'var(--fg, #0f172a)',
          ...
          {t('order_success.delivered_title') || 'Order Delivered! 📦🎉'}
        </h1>
        ...
        <p style={{
          ...
          {t('order_success.delivered_subtitle') || 'Your package has been safely delivered. Thank you for shopping with us!'}
        </p>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: '0.92rem', fontWeight: 700, color: '#22c55e', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
